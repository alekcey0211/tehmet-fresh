    ...
    <>
      <section class="hidden md:block py-4 sm:py-8 lg:py-20 bg-light-blue max-w-fullhd mx-auto">
        <div class="relative mb-2 lg:mb-16">
          <div class="font-light text-2xl sm:text-4xl lg:text-5xl text-dark-blue lg:leading-[80px] text-right mr-4 sm:mr-8 lg:mr-[410px] uppercase sm:mb-4 lg:mb-0">
            НАШИ ПАРТНЕРЫ
          </div>
      ...
      <section class="p-4 sm:p-8 md:hidden">
        <div class="max-w-fullhd mx-auto">
          <div class="text-dark-blue text-lg sm:text-4xl font-light gradient-text uppercase mb-2 text-right">
            Наши партнеры
          </div>
